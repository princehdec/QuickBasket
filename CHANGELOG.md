...
- Payment routes now capture the raw Razorpay webhook body, verify `x-razorpay-signature`, validate payment amounts, and apply idempotent captured/failed/refunded state transitions to payment and order records.
