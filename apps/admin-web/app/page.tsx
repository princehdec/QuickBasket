...
export default function AdminHome() {
  ...
  useEffect(() => {
    loadJobs().catch((error: unknown) => setMessage(error instanceof Error ? error.message : "Could not load dispatch jobs / dispatch jobs नहीं लोड हुए")).finally(() => setLoading(false));
  }, [loadJobs]);
